 ...
 * 帶分數一律用 space 格式（2 1/3）— 同 app 鍵盤輸出、CLAUDE.md 格式鐵律
 * 及其他 guide 一致（2026-07-08 由「2 1/3」統一改過嚟）。
 */
  ...
  return (
    <article className="prose-guide space-y-6 text-gray-800 leading-relaxed">
      ...
      <section>
        ...
        <div className="bg-gray-50 rounded-xl p-4 mt-3 font-mono text-sm">
          <p className="font-sans font-semibold mb-2">例題三：2 1/3 + 1 3/4</p>
          <p>分數部分：1/3 = 4/12，3/4 = 9/12</p>
          <p>4/12 + 9/12 = 13/12 = 1 1/12（進位）</p>
          <p>整數部分：2 + 1 = 3，再加進位的 1</p>
          <p>答案：<strong>4 1/12</strong></p>
        </div>
        <p className="text-sm text-gray-500 mt-2">
      ...
      <section>
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            <strong>帶分數減法唔識借位</strong>：3 1/4 − 1 3/4，分數部分 1/4 唔夠減 3/4，
            要從整數借 1（3 1/4 = 2 5/4），變成 2 5/4 − 1 3/4 = 1 2/4 = 1 1/2。
          </li>
        </ul>
      </section>
...
export const p5U2FractionAddSub: UnitGuide = {
  ...
  faq: [
    ...
    {
      q: '帶分數減法分數部分唔夠減點算？',
      a: '從整數部分借 1 化做假分數再減。例如 3 1/4 − 1 3/4：把 3 1/4 寫成 2 5/4，然後 2 5/4 − 1 3/4 = 1 2/4 = 1 1/2。',
    },
    {
      q: '小朋友異分母分數成日錯，應該點補底？',
