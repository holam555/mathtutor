...
WITH ins AS (
  ...
  VALUES
    (4, 'A', 1, '倍數和因數', 'P4 單元 1 倍數和因數', 1),
    (4, 'A', 2, '公倍數和公因數', 'P4 單元 2 公倍數和公因數', 2),
    (4, 'A', 3, '乘法', 'P4 單元 3 乘法', 3),
    (4, 'A', 4, '除法', 'P4 單元 4 除法', 4),
    (4, 'A', 5, '四則混合運算', 'P4 單元 5 四則混合運算', 5),
    (4, 'A', 7, '平行與垂直', 'P4 單元 7 平行與垂直', 7),
    (4, 'A', 8, '四邊形', 'P4 單元 8 四邊形', 8),
    (4, 'A', 9, '周界', 'P4 單元 9 周界', 9),
    (4, 'B', 10, '分數的認識（一）', 'P4 單元 10 分數的認識（一）', 10),
    (4, 'B', 11, '擴分與約分', 'P4 單元 11 擴分與約分', 11),
    (4, 'B', 12, '同分母分數加減法', 'P4 單元 12 同分母分數加減法', 12),
    (4, 'B', 13, '小數的認識', 'P4 單元 13 小數的認識', 13),
    (4, 'B', 14, '圖形的拼砌與分割', 'P4 單元 14 圖形的拼砌與分割', 14),
    (4, 'B', 15, '對稱圖形', 'P4 單元 15 對稱圖形', 15),
    (4, 'B', 16, '正方形和長方形面積', 'P4 單元 16 正方形和長方形面積', 16),
    (4, 'B', 17, '棒形圖（一）單式棒形圖', 'P4 單元 17 棒形圖（一）單式棒形圖', 17),
    (4, 'B', 18, '棒形圖（二）複式棒形圖', 'P4 單元 18 棒形圖（二）複式棒形圖', 18)
