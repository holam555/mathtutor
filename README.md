...
A math practice platform for a Hong Kong tutoring business, built to replace ad-hoc WhatsApp'd worksheets with something that actually adapts to each kid.

Three roles, one app: students grind mobile-first practice sessions, parents set exam scopes and track progress, teachers curate the question bank and mark long-answer work. Built solo, end to end — schema design, RLS policies, AI pipelines, the works.
